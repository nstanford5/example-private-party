...
class _Either_1 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_9.alignment().concat(_descriptor_2.alignment()));
  }
  fromValue(value_0) {
    return {
      is_left: _descriptor_5.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_9.toValue(value_0.left).concat(_descriptor_2.toValue(value_0.right)));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      rsvp: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`rsvp: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(_address_0),
        ...
        const result_0 = this._rsvp_0(context, partialProofData, _address_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      startParty: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`startParty: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('startParty',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 58 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._startParty_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      closeEntry: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`closeEntry: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeEntry',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 67 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._closeEntry_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      checkIn: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkIn',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 78 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(address_0),
            alignment: _descriptor_2.alignment()
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._checkIn_0(context, partialProofData, address_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      claimFees: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`claimFees: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const address_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claimFees',
                                     'argument 1 (as invoked from Typescript)',
                                     'private-party.compact line 102 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(address_0) === 'object' && address_0.bytes.buffer instanceof ArrayBuffer && address_0.bytes.BYTES_PER_ELEMENT === 1 && address_0.bytes.length === 32)) {
        ...
        const result_0 = this._claimFees_0(context, partialProofData, address_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
  ...
  _localSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('localSecret',
                                 'return value',
                                 'private-party.compact line 21 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _rsvp_0(context, partialProofData, _address_0) {
    const _secret_0 = this._localSecret_0(context, partialProofData);
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    if (this._equal_2(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
  ...
  _closeEntry_0(context, partialProofData) {
    const _secret_0 = this._localSecret_0(context, partialProofData);
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
  ...
  _checkIn_0(context, partialProofData, address_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_11.toValue(5n),
                                                                                                                   alignment: _descriptor_11.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(address_0),
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    if (this._equal_5(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
  ...
  _claimFees_0(context, partialProofData, address_0) {
    const _secret_0 = this._localSecret_0(context, partialProofData);
    const pubKey_0 = this._getDappPublicKey_0(_secret_0);
    ...
    __compactRuntime.assert((t_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                             ...
                             t_0 > 0n),
                            'No fees to claim');
    const totalCollected_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                        { idx: { cached: false,
  ...
  _commitAddress_0(_secret_0, _address_0) {
